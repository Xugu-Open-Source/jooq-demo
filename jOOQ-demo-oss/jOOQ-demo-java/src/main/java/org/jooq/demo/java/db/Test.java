...
public class Test extends SchemaImpl {
    ...
    public static Result<FilmInStockRecord> FILM_IN_STOCK(
        ...
        return configuration.dsl().selectFrom(FilmInStock.FILM_IN_STOCK.call(
              pFilmId
            , pStoreId
        )).fetch();
    }
    ...
    public static FilmInStock FILM_IN_STOCK(
        ...
        return FilmInStock.FILM_IN_STOCK.call(
            pFilmId,
            pStoreId
        );
    }
    ...
    public static Result<FilmNotInStockRecord> FILM_NOT_IN_STOCK(
        ...
        return configuration.dsl().selectFrom(FilmNotInStock.FILM_NOT_IN_STOCK.call(
              pFilmId
            , pStoreId
        )).fetch();
    }
    ...
    public static FilmNotInStock FILM_NOT_IN_STOCK(
        ...
        return FilmNotInStock.FILM_NOT_IN_STOCK.call(
            pFilmId,
            pStoreId
        );
    }
    ...
    public static Result<CustomerRecord> REWARDS_REPORT(
        ...
        return configuration.dsl().selectFrom(RewardsReport.REWARDS_REPORT.call(
              minMonthlyPurchases
    ...
    public static RewardsReport REWARDS_REPORT(
        ...
        return RewardsReport.REWARDS_REPORT.call(
            minMonthlyPurchases,
            minDollarAmountPurchased
        );
    }
